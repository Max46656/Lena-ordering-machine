    ...
    <div class="content  bg-info  " style="">
      ...
      <nav id="navspy" class="navbar navbar-expand-lg navbar-light sticky-top  ">
        <a class="navbar-brand row" href="#">
          ...
          <img style="width:auto" class="col-6 p-0" src="imge/hadog.png" alt="">
        </a>
        <button class="navbar-toggler" style=width:100px type="button" data-toggle="collapse"
      ...
      <footer class="pcolor page-f  mt-5">
        <div class="row ">
          <div class="col text-center">copyRight@MaxCaulfield</div>
        </div>
      </footer>
    </div>
