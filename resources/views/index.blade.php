...
<div class="" id="c">
  <div class=" select_data flex justify-center" style="padding-top:160px">
    ...
    <div class="add-edit py-4 ">
      <a href="{{ route('addRes') }}"><button type="button"
          class="btn py-3 px-6  mx-4 bg-blue-300 hover:bg-blue-400  rounded-lg">新增餐廳</button></a>
      <a href="{{ route('addMenu') }}"><button type="button"
          class="btn py-3 px-6 mx-4 bg-yellow-200  hover:bg-yellow-300 rounded-lg">編輯菜單</button></a>
    </div>
    @endif
