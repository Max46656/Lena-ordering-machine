      ...
      @section('content')
          <div class="row" id="c">
              <div class="col-12 text-center" style="margin: 30px 0 3px 0;">
                  <a href="{{ url('/add-resturant') }}"><button type="button" class="btn btn-primary">新增餐廳</button></a>
                   <a href="{{ url('/add-menu') }}"><button type="button" class="btn btn-warning">編輯菜單</button></a>
              </div>
              <div class="col-12">
                  <hr>
              </div>
          ...
          <div class="pcolor row justify-content-center" style="color: white;">
              ...
              "
                      ...
                      <div class="pro mb-4">
                          <div class="spro">
                              <a href="{{ url('/menu/'.$item->id) }}" target="_blank">{{$item->title}}</a>
                              <p>
                                 電話:{{$item->tel}}
                              </p>
                              <p>
