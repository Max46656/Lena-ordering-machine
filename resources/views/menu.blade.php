...
<div class="container  mx-auto">
  <div class="row" style="padding-top:150px">
    ...
    <div class="mover_anmition">
      ...
      <a href="{{ route('CartPage') }}"><button type="button" class="btn py-3 px-6 my-4 ml-8 bg-yellow-200 hover:bg-yellow-300 active:bg-yellow-600 rounded-lg">目前購物車</button></a>
    </div>
    ...
    <div class="card-body mb-8 mover_anmition_menu" >
      <form action="{{ $fromAction }}" method="post" >
        ...
        <button type="submit"  class="w-full btn py-3 px-6 my-8  bg-blue-200 hover:bg-blue-300 active:bg-blue-400 rounded-lg">送出</button>
      </form>
    </div>
  </div>
</div>
