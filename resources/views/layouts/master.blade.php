  ...
  <div class="content">
    ...
    <nav id="navspy" class="navbar navbar-expand-lg navbar-light sticky-top">
      <a class="navbar-brand row" href="#">
        ...
        <img style="margin-left: 20px;width: 250px;height: 60px;" class="col-6 p-0" src="imge/hadog.png" alt="">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto  text-center">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="{{ rourw('getMenu',[session(['restaurant'])]) }}">今日餐廳</a>
            @else
          ...
          <div
            ...
            <div class="hidden fixed top-0 right-0 sm:block">
              ...
              @auth
              <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">帳號設定</a>
              @else
